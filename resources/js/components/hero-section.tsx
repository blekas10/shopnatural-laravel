    ...
    return (
        ...
        >
            ...
            <div className="container relative z-10 mx-auto flex flex-col items-center gap-8 px-4 text-center md:px-6 lg:items-start lg:px-8 lg:text-left">
                <h1 className="text-4xl font-medium uppercase leading-tight tracking-wide text-foreground sm:text-5xl md:text-6xl lg:text-7xl xl:text-7xl">
                    <span className="text-gold">Natural Beauty</span><br />{' '}
                    <span className="text-teal">Natural You</span>
                </h1>
